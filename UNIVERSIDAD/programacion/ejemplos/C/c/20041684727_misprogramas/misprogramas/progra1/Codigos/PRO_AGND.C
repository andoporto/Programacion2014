...
#include <dos.h>
 ...
 for(;;)
  {
   ...
   if (!nombre[0])
	...
	clrscr();
	 ...
	 if (aux)
	  {
	gotoxy(4,2); textcolor(14);
	cprintf("Nombre: "); textcolor(14);
	cprintf("%s",aux->nombre);
	gotoxy(4,4); textcolor(14);
	cprintf("Apellido: "); textcolor(14);
	cprintf("%s",aux->apellido);
	gotoxy(4,6); textcolor(14);
	cprintf("Edad: "); textcolor(14);
	cprintf("%s",aux->edad);
	gotoxy(4,8); textcolor(14);
	cprintf("Telef¢no: "); textcolor(color1);
	cprintf("%s",aux->telf);
	gotoxy(4,10); textcolor(14);
	cprintf("Direcci¢n: "); textcolor(14);
 ...
 /* ------------MENU PARA MODIFICAR LOS REGISTROS DEL ARCHIVO--------------*/
