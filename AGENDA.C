...
void menu(char *fname)
{
    ...
    do
    {
        ...
        gotoxy(4,5);
        cprintf("            (1) ------------> INSERTAR REGISTROS");
        gotoxy(4,7);
        cprintf("            (2) ------------> EXAMINAR REGISTROS");
        gotoxy(4,9);
        cprintf("            (3) ------------> BUSCAR REGISTROS");
        gotoxy(4,11);
        cprintf("            (4) ------------> GUARDAR REGISTROS ");
        gotoxy(4,13);
        cprintf("            (5) ------------> SALIR A MENU PRINCIPAL");
        gotoxy(4,15);
...
void cargar(int clave)
{
    ...
    for (;;)
    {
        ...
        else if (f != NULL)  /* el archivo ya existe */
        {
            ...
            else if (clave)  /* si se desea cargar archivo y el archivo existe */
            {
                carga(fname);
                menu(fname);
                return;
...
void menu_prin(void)
{
    ...
    for (;;)
    {
        ...
        gotoxy(28,8);
        textcolor (10);
        cprintf("(1) NUEVO REGISTRO");
        gotoxy(28,10);
        cprintf("(2) CARGAR REGISTRO");
        gotoxy(28,12);
        cprintf("(3) SALIR");
        gotoxy(28,16);
