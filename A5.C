...
char seccionvalida(char,char,char,char);
int perfecto(int);
int factorial(int);
...
char sec, secant, secmin, secmax,a, b, c,f;
...
char seccionvalida (char a, char b, char c, char f)
{
	char seccion;
	do
	{
